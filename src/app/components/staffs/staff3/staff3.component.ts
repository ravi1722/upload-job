...
@Component({
  selector: 'app-staff3',
  templateUrl: './staff3.component.html',
  styleUrls: ['./staff3.component.css']
})
export class Staff3Component implements OnInit {
  ...
  whole_id: any;
  ngOnInit(): void {
    this.apiService.getStaff3().subscribe( (data : any) => {
      this.users = data;
  });
  }
  ...
  deleteUser(user: User): void {
    ...
    this.apiService.deleteStaff3(user.id).subscribe(data => {

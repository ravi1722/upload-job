...
@Component({
  selector: 'app-staff4',
  templateUrl: './staff4.component.html',
  styleUrls: ['./staff4.component.css']
})
export class Staff4Component implements OnInit {
  ...
  whole_id: any;
  ngOnInit(): void {
    this.apiService.getStaff4().subscribe( (data : any) => {
      this.users = data;
  });
  }
  ...
  deleteUser(user: User): void {
    ...
    this.apiService.deleteStaff4(user.id).subscribe(data => {
